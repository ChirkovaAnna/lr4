...
osThreadId myTaskReceiveHandle;
...
//                ex.x = GPIOC->IDR & (GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7) ; // считываем значиние с порта С (0-7 пинов)                               //устанавливаем i = 0
...
//                    TIM1->ARR = tim.count2;             //установка таймера на count2=10000-1
//                                            }
//            else
//                {   ex.a = 3;                           //устанавливаем ex.a = 3
//                    TIM1->ARR = tim.count1;             //установка таймера на count1=2000-1
//                                           }
//            TIM1->CNT=0;                                // сбрасываем значение таймера
//        }
...
//                          |GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7 );                  //установка 1 на пины от 0 до 7 (11111111 = 0xff)
//                    HAL_TIM_Base_Start_IT(&htim1);  			 //включаем таймер
//                    ex.i++;                    			 // ex.i = ex.i + 1
...
/**
* @brief Function implementing the myTaskReceive thread.
* @param argument: Not used
* @retval None
*/
